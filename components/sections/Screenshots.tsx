  ...
  return (
    <section id="screens" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mt-12 -mr-6 md:mt-16 md:-mr-12">
          <div className="flex snap-x snap-mandatory gap-5 overflow-x-auto pb-6 pr-6 [scrollbar-width:none] md:gap-8 md:pr-12 [&::-webkit-scrollbar]:hidden">
            {SHOTS.map((s) => (
