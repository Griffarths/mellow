export default function PrivacyContentEn() {
  return (
    <>
      ...
      <ul>
        <li>
          Download and use our mobile application (Mellow), or any other
      ...
      <p>
        ...
        health data. We may process sensitive personal information when
      ...
      <p>
        <em>In Short:</em> We collect personal information that you provide to
        us.
      </p>
      <p>
      ...
      <p>
        ...
        RevenueCat. You may find their privacy notice link(s) here:{" "}
        <a
      ...
      <ul>
        ...
        <li>
          ...
          the type and settings of the device you use to access the Services.
      ...
      <ul>
        <li>Cloud Computing Services: Supabase</li>
        <li>
          Functionality and Infrastructure Optimization: Supabase and
          WeatherKit (Apple)
        </li>
      ...
      <p>
        ...
        and our third-party providers. These clauses require all recipients
        to protect all personal information that they process originating
        from the EEA or UK in accordance with European data protection laws
      ...
      <p>
        <em>In Short:</em> We do not knowingly collect data from or market to
      ...
      <p>
        <em>In Short:</em> Depending on your state of residence in the US or
      ...
      <p>
        ...
        information. You can make such a request by contacting us using the
        contact details provided in section 13 below.
      </p>
      <p>
        We will consider and act upon any request in accordance with
        applicable data protection laws.
      ...
      <p>
        <em>In Short:</em> If you are a resident of California, Colorado,
      ...
      <ul>
        <li>A. Identifiers (name, email, IP address) → YES</li>
        <li>
          B. Personal information as defined in the California Customer
          Records statute → YES
        </li>
        <li>
          C. Protected classification characteristics (gender, age, race) →
          NO
        </li>
        <li>D. Commercial information (purchase history) → YES</li>
        <li>E. Biometric information → NO</li>
        <li>F. Internet or other similar network activity → NO</li>
        <li>G. Geolocation data → YES</li>
        <li>H. Audio, electronic, sensory, or similar information → NO</li>
        <li>I. Professional or employment-related information → NO</li>
        <li>J. Education Information → NO</li>
        <li>K. Inferences drawn from collected personal information → NO</li>
        <li>
          L. Sensitive personal information (health data and precise
          geolocation) → YES
        </li>
      </ul>
      <p>
      ...
      <p>
        <strong>Your Rights:</strong> You have rights under certain US state
      ...
      <p>
        <strong>How to Exercise Your Rights:</strong> You can contact us by
        emailing us at{" "}
        <a href="mailto:contact.mellow@proton.me">contact.mellow@proton.me</a>.
      </p>
      <p>
        <strong>Request Verification:</strong> Upon receiving your request,
        we will need to verify your identity to determine you are the same
        person about whom we have the information in our system.
      </p>
      <p>
        <strong>Appeals:</strong> Under certain US state data protection
        ...
        response to the appeal. If your appeal is denied, you may submit a
      ...
      <p>
        ...
        please submit your request in writing to us using the contact details
