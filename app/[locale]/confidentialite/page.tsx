        ...
        <article className="prose prose-neutral mt-6 max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-h1:text-4xl md:prose-h1:text-5xl prose-h2:mt-14 prose-h2:text-2xl md:prose-h2:text-3xl prose-h3:mt-10 prose-h3:text-xl prose-p:text-black/70 prose-a:text-mellow-rose prose-a:underline-offset-2 prose-strong:text-ink prose-li:text-black/70">
          ...
          <ul>
            ...
            <li>
              ...
              migraines. It allows users to log migraine episodes, track
              triggers and treatments, monitor atmospheric pressure, and access
              educational content about migraines.
            </li>
            <li>
          ...
          <p>
            <em>In Short:</em> We collect personal information that you provide
            to us.
          </p>
          <p>
          ...
          <p>
            ...
            we believe it is necessary and we have a valid legal reason to do
          ...
          <p>
            ...
            by law in your jurisdiction, nor do we knowingly sell such personal
          ...
          <p>
            ...
            provided in section 13 below. Please note that this will not affect
          ...
          <p>
            <strong>Your Rights:</strong> You have rights under certain US
